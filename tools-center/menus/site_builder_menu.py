...
def _build_items():
    ...
    result = []
    for tool in tools:
        icon  = tool.get("icon", icons.get("web"))
...
def _fallback_items():
    ...
    return [
        ("🌐", "Create Project",  lambda: print("  Running: Create Project")),
        ("🌐", "Open Project",    lambda: print("  Running: Open Project")),
        ("🌐", "Preview Server",  lambda: print("  Running: Preview Server")),
        ("🌐", "Template Loader", lambda: print("  Running: Template Loader")),
    ]
